    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Tambah Soal Psikotes</li>
            </ul>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12">
...
<div class="row clearfix">
    <div class="col-md-12">
        <div class="card">
            <div class="header">
                <h2>Tambah Data Soal Psikotes</h2>
                <hr>
            </div>
            <div class="body">
                <form action="<?= base_url() ?>Admin/tambahPsikotes" method="POST">
                    <table class="table">
                        <thead>
                            <tr>
