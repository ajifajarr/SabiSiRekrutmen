                            ...
                            foreach ($lowongan as $row) { ?>
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <a href="<?= base_url() ?>Manager/Detail_Pelamar_Tidak_Diterima/<?= $row->id_lowongan ?>"> <button class="btn btn-primary"><i class="fa fa-search"></i> Lihat Pelamar Tidak Diterima</button></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
