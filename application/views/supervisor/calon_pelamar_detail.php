    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?= base_url() ?>Supervisor/Calon_Pelamar">Calon Pelamar</a></li>
...
<div class="row clearfix">
    ...
    <div class="col-lg-12 col-md-12" style="margin-bottom: 20px;">
        <?php if ($apply['status_hasil'] == 'Menunggu') { ?>
            <a href="<?= base_url() ?>Supervisor/ApproveApply/<?= $apply['id_apply_job'] ?>"><button class="btn btn-success"><i class="fa fa-check"></i> Approve</button></a>
            <a href="<?= base_url() ?>Supervisor/CancelApply/<?= $apply['id_apply_job'] ?>"><button class="btn btn-danger"><i class="fa fa-close"></i> Reject</button></a>
        <?php } ?>
